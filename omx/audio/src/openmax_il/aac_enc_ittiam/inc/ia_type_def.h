...
typedef float				*	p_float32;/*	pf		p_float32 pf_count	4	*/
typedef double					FLOAT64	;/*	d		UFLOAT64 d_count		8	*/
typedef double				*	p_float64;/*	pd		p_float64 pd_count	8	*/
