...
typedef struct XDM1_BufDesc {
    XDAS_Int32   numBufs;   /**< Number of buffers in @descs array.
                             *
...
typedef struct XDM_Context {
    ...
    XDM1_SingleBufDesc inBufs[XDM_MAX_CONTEXT_BUFFERS];  /**< Input data buffers.
                                     *
                                     *   @remarks  This is a sparse array.
                                     */
    XDM1_SingleBufDesc outBufs[XDM_MAX_CONTEXT_BUFFERS]; /**< Output data buffers.
                                     *
                                     *   @remarks  This is a sparse array.
                                     */
    XDM1_SingleBufDesc inOutBufs[XDM_MAX_CONTEXT_BUFFERS]; /**< Input/Output data buffers.
                                     *
                                     *   @remarks  This is a sparse array.
                                     */
    ...
    XDM1_SingleBufDesc intermediateBufs[XDM_MAX_CONTEXT_BUFFERS]; /**< Intermediate, working buffers.
                                     ...
                                     *             these buffers are treated
                                     *             as OUT buffers (i.e., written to by
                                     *             the algorithm).  For BACK codec
                                     *             parts, these buffers are treated as
                                     *             IN buffers (i.e., read from by the
                                     *             algorithm).  For MIDDLE codec parts,
                                     *             these buffers are treated as IN/OUT
                                     *             buffers (i.e., the codec can read
