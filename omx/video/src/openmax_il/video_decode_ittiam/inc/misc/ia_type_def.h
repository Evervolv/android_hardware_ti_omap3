...
#else
typedef signed long             WORD40  ;/* m       WORD40   m_count    5   */
typedef signed long         *   pWORD40 ;/* pm      pWORD40  pm_count   5   */
typedef unsigned long           UWORD40 ;/* um      UWORD40  um_count   5   */
typedef unsigned long       *   pUWORD40;/* pum     pUWORD40 pum_count  5   */
